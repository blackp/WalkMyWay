...
@interface PBTripMapView (FileInternal)
          ...
          inContext:(CGContextRef)context
{
    ...
    CGPathRef path = [self newPathForPoints:pbTripMap.points
                                 pointCount:pbTripMap.pointCount
                                   clipRect:clipRect
                                  zoomScale:zoomScale];
    ...
    if (path != nil)
    {
        ...
        CGContextSetRGBStrokeColor(context, 0.0f, 1.0f, 0.0f, 0.5f);
...
@implementation PBTripMapView (FileInternal)
